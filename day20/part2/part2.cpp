...
unsigned long long findRoomsWithMinPath()
{
	...
	return std::ranges::count_if(visited | std::views::values, [](auto const entry) { return entry.second >= 1000; });
}
...
int main()
{
	...
	const auto answer = findRoomsWithMinPath();
